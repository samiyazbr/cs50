...
ADD caller_name datatype;

ALTER TABLE phone_calls
ADD receiver_name datatype;
...
-- WE got the id from the table we got from the previous query
SELECT city FROM airports WHERE id = 8; --origin_airport_city
SELECT city FROM airports WHERE id = 4; --destination_airport_city

-- another way to find the origin and destination airport
